...
class DataSet:
    """DataSet class. A DataSet consists of grid points and matching function values. The DataSet can return information
     on its size, the dimension of the underlying coordinates, and the coordinate data for a given coordinate axis.
    """
